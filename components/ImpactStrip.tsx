          ...
          {impactMetrics.map((metric, i) => {
            ...
            return (
              <motion.div
                ...
                className="group relative bg-slate-900/40 border border-slate-800/50 rounded-2xl p-5 sm:p-6 text-center hover:border-blue-500/30 transition-all duration-500 hover:-translate-y-1 hover:shadow-lg hover:shadow-blue-500/5"
              >
                ...
                <div className="text-slate-500 text-xs">{metric.detail}</div>
              </motion.div>
            );
          })}
        </div>
